 ...
 * Description:添加工人费用使用的适配器
 */

public class FeeWorkerSelectAdapter extends SuperAdapter<LaborFeeData.LaborData> {
    private ArrayList<LaborFeeData.LaborData> selectData = new ArrayList<>();

    public FeeWorkerSelectAdapter(Context context, List<LaborFeeData.LaborData> items, int layoutResId) {
