...
import utils.glideUtils.transformation.BlurTransformation;
import utils.glideUtils.transformation.CircleTransformation;
import utils.glideUtils.transformation.RadiusTransformation;
...
//             .priority(Priority.HIGH)
   ...
   * @param radious
   */
  public  void loadCustRoundCircleImage(Context context, String url, ImageView imageView,int  radious) {
    RequestOptions options = new RequestOptions()
            .centerCrop()
            .placeholder(placeholderSoWhite)
            .error(errorSoWhite)
            //.priority(Priority.HIGH)
            .bitmapTransform(new RadiusTransformation(context,radious))
            .diskCacheStrategy(DiskCacheStrategy.ALL);
